...
public class Leaderboard extends GodotPlugin {
    ...
    public Set<SignalInfo> getPluginSignals() {
        ...
        signals.add(new SignalInfo("leaderboard_error", String. class));
        signals.add(new SignalInfo("leaderboard_completed"));
    ...
    public void show() {
        ...
        if (status != ConnectionResult.SUCCESS) {
            emitSignal("leaderboard_error", "ERROR_GOOGLE_PLAY_UNAVAILABLE");
        ...
        request.addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                flow.addOnCompleteListener(reviewFlow -> {
                    ...
                    emitSignal("leaderboard_completed");
                });

            } else {
                emitSignal("leaderboard_error", "ERROR_UNKNOWN");
            }
        });
    }
}
